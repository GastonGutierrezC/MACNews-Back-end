...
import { IUserRecommendationsRepository } from './Interface/userRecommendations.repository.interface';

@Injectable()
export class UserRecommendationsRepository implements IUserRecommendationsRepository {
  constructor(
